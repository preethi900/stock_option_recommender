        ...
        try:
            ...
            agent = Agent(
                ...
                instructions=[
                    ...
                    "(lean bullish). Use this to justify the strategy.",
                    ...
                    "7. Important: Keep the entire response short, scannable, and avoid long paragraphs. "
            ...
            with st.spinner(f"Analyzing {ticker} market data and news..."):
                ...
                response: RunOutput = agent.run(
                    f"Analyze {ticker} and predict its weekly price target with confidence and probability. "
                    f"Suggest a {strategy_type} option strategy with a {timeframe} timeframe.",
                    stream=False
                )
